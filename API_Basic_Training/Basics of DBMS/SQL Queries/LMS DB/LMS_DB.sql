...
CREATE TABLE `aut01` (
  ...
  `T01F02` varchar(255) NOT NULL COMMENT 'AUTHOR NAME',
  PRIMARY KEY (`T01F01`)
...
CREATE TABLE `boo01` (
  ...
  `O01F02` varchar(255) NOT NULL COMMENT 'BOOK TITLE',
  `O01F03` int DEFAULT NULL COMMENT 'AUTHOR ID',
...
INSERT INTO `boo01` VALUES (1,'Harry Potter',1,'Fiction'),(2,'Hamlet',2,'Drama'),(3,'Half Girlfriend',3,'Love-Story'),(4,'Harry Potter 2',1,'Fiction');
...
CREATE TABLE `boo02` (
  ...
  `O02F02` int DEFAULT NULL COMMENT 'USER ID',
  `O02F03` int DEFAULT NULL COMMENT 'BOOK ID',
  `O02F04` date DEFAULT NULL COMMENT 'BORROW DATE',
  `O02F05` date DEFAULT NULL COMMENT 'RETURN DATE',
  PRIMARY KEY (`O02F01`),
  KEY `O02F02` (`O02F02`),
  KEY `O02F03` (`O02F03`),
...
INSERT INTO `boo02` VALUES (4,1,2,'2023-11-28','2023-12-13'),(5,2,3,'2023-11-26','2023-12-11'),(6,3,1,'2023-11-25','2023-12-10');
...
CREATE TABLE `tra01` (
  ...
  `A01F02` int DEFAULT NULL COMMENT 'USER ID',
  `A01F03` varchar(20) NOT NULL COMMENT 'TRANSACTION TYPE',
...
INSERT INTO `tra01` VALUES (1,1,'Borrow','2023-11-28'),(2,2,'Borrow','2023-11-26'),(3,3,'Borrow','2023-11-25'),(4,1,'Return','2023-11-20');
...
CREATE TABLE `use01` (
  ...
  `E01F02` varchar(50) NOT NULL COMMENT 'USERNAME',
  `E01F03` varchar(255) NOT NULL COMMENT 'PASSWORD',
  PRIMARY KEY (`E01F01`)
...
-- Dump completed on 2023-11-28 15:15:56
